...
const Product = sequelize.define("product", {
  ...
  pdf_file: { type: DataTypes.STRING, allowNull: false },
  zip_file: { type: DataTypes.STRING, allowNull: true },
});
...
// модель «Таймфрейм», таблица БД brand
...
User.hasMany(Product, { onDelete: "RESTRICT" });
Product.belongsTo(User);

Basket.hasOne(User, { onDelete: "RESTRICT" });
User.belongsTo(Basket);
User.hasOne(Basket, { onDelete: "RESTRICT" });
